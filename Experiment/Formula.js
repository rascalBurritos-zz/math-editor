...
//     this.leftCaretNode.replaceWith(this._elements[0].leftCaretNode);
//     this.rightCaretNode.replaceWith(this._elements.slice(-1)[0].rightCaretNode);
...
//       const middleMan = new CaretNode({ parent });
